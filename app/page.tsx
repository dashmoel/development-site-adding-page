...
export default function Home() {
  return (
    <><head><link rel="icon" href="icon.ico" type="image" sizes="any"></link></head><body>
...
<main className="flex min-h-screen flex-col items-center justify-between p-24">
                <>
                    <div className='flex flexcenter lg:items-start'>
                        ...
                        Podcast Show TheWiTch?!&nbsp;<code className="font-mono font-bold"> it's a big project to produce! But Socrates said “speak so that I may see you!” Do you wanna see me! 
                        </code>
                        </p>
                    </div> 
                    <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
                        <a
                            className="pointer-events flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0"
                            href="https://thewitchpodcastshow.netlify.app"
                            target="_blank"
                ...
                <div className='flex-col flex items-center flexcenter lg:items-start'>
                        <h1>Social experiments in English!
                            <span 
                    ...
                    <div className="relative flex place-items-center justify-center before:absolute before:h-[30px] before:w-[80px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]">
                        ...
                        rel="noopener noreferrer"
                        >
                        <Image className="relative flex items-center  flexcenter p-29 justify-center dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark"
                        src="/English.ico"
                        alt="Next.js Logo"
                        width={350}
                        height={29}
